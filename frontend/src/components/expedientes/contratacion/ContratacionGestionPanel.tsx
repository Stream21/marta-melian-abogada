        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              Supervise el avance del cliente y valide cada hito antes de pasar a documentación.
            </p>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            {subfaseContratacion && (
        ...
        {data.contratacionCompletada && (
          <div className="mt-6 rounded-lg border border-emerald-200 bg-emerald-50 p-4">
            <p className="text-sm font-medium text-emerald-800">
              Contratación completada. Use «Pasar a Fase 2» e indique el plazo de espera de
              documentación antes de avanzar.
            </p>
          </div>
        )}
      </div>
