/** Contenido por defecto de la Hoja de Encargo Profesional (basado en documento firmado). */

export const HOJA_ENCARGO_REUNIDOS =
  'De una parte, [[NOMBRE_LETRADA]], con DNI [[NIF_LETRADA]], abogada colegiada en el [[COLEGIO_ABOGADOS]], ' +
...
export const HOJA_ENCARGO_EXPONEN =
  'Que las partes se reconocen mutuamente la capacidad legal suficiente para otorgar esta HOJA DE ' +
  'ENCARGO PROFESIONAL y acuerdan suscribir el presente contrato, que se regirá por las siguientes:';

export const HOJA_ENCARGO_ESTIPULACIONES = `PRIMERA.- RÉGIMEN JURÍDICO
...
export const HOJA_ENCARGO_PROTECCION_DATOS_FILAS: Array<{ label: string; value: string }> = [
  ...
  { label: 'Legitimación', value: 'Consentimiento expreso del interesado, la CLIENTE.' },
  {
    label: 'Destinatarios',
    value:
      'Los posibles destinatarios serán las profesionales intervinientes en el proceso legal en cumplimiento del contrato de servicios u hoja de encargo profesional suscrita entre la ABOGADA y la CLIENTE.',
  },
  {
    label: 'Derechos',
    value:
  ...
  },
  {
    ...
    value:
      'Para obtener más información acerca de la política de protección de datos, puede ser requerida la misma al responsable del tratamiento de los datos, a través del email facilitado ([[EMAIL_DESPACHO]]).',
  },
];

export const HOJA_ENCARGO_CIERRE =
  'Este documento ha sido entregado previamente al CLIENTE a fin de que procediera a su lectura ' +
